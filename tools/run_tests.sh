...
run "pickups: pushed aside on drag"  res://tools/test_pickup_push.gd    "test_pickup_push: PASS"
...
run "combat: companions"             res://tools/test_companion.gd      "test_companion: PASS"
